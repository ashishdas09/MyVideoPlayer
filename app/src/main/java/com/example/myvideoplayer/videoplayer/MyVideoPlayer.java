		           ...
		           SeekBar.OnSeekBarChangeListener
{
	...
	private void init(Context context, AttributeSet attrs)
	{
		...
		if (attrs != null)
		{
			...
			try
			{
				String source = a.getString(R.styleable.MyVideoPlayer_vp_source);
				...
				mLeftAction = a.getInteger(R.styleable.MyVideoPlayer_vp_leftAction, LEFT_ACTION_RESTART);
				//noinspection WrongConstant
				mRightAction = a.getInteger(R.styleable.MyVideoPlayer_vp_rightAction, RIGHT_ACTION_NONE);

				mCustomLabelText = a.getText(R.styleable.MyVideoPlayer_vp_customLabelText);
				mRetryText = a.getText(R.styleable.MyVideoPlayer_vp_retryText);
				mSubmitText = a.getText(R.styleable.MyVideoPlayer_vp_submitText);
				mBottomLabelText = a.getText(R.styleable.MyVideoPlayer_vp_bottomText);

				int restartDrawableResId =
						a.getResourceId(R.styleable.MyVideoPlayer_vp_restartDrawable, -1);
				int playDrawableResId = a.getResourceId(R.styleable.MyVideoPlayer_vp_playDrawable, -1);
				int pauseDrawableResId = a.getResourceId(R.styleable.MyVideoPlayer_vp_pauseDrawable, -1);
				...
				mHideControlsOnPlay =
						a.getBoolean(R.styleable.MyVideoPlayer_vp_hideControlsOnPlay, true);
				mAutoPlay = a.getBoolean(R.styleable.MyVideoPlayer_vp_autoPlay, false);
				mControlsDisabled = a.getBoolean(R.styleable.MyVideoPlayer_vp_disableControls, false);

				mThemeColor =
						a.getColor(
								R.styleable.MyVideoPlayer_vp_themeColor,
								Util.resolveColor(context, R.attr.colorPrimary));

				mAutoFullscreen = a.getBoolean(R.styleable.MyVideoPlayer_vp_autoFullscreen, false);
				mLoop = a.getBoolean(R.styleable.MyVideoPlayer_vp_loop, false);
			}
			finally
			{
				a.recycle();
	...
	protected void onFinishInflate()
	{
		...
		mProgressFrame = li.inflate(R.layout.vp_include_progress, this, false);
		...
		// Inflate controls
		mControlsFrame = li.inflate(R.layout.vp_include_controls, this, false);
		...
		final MyVideoPlayer myVideoPlayer = this;
