...
interface IPublicMethods
{
  ...
  void setPlayerListener(@NonNull MyVideoPlayerListener playerListener);

  void setProgressListener(@NonNull MyVideoProgressListener callback);

  void setLeftAction(@MyVideoPlayer.LeftAction int action);

  void setRightAction(@MyVideoPlayer.RightAction int action);
